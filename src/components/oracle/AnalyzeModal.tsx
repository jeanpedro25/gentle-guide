...
import { X, Zap, TrendingUp, AlertTriangle, Target, DollarSign } from 'lucide-react';
...
export function AnalyzeModal({ isOpen, onClose, oracle, homeTeam, awayTeam, isLoading, bankrollAmount = 1000 }: AnalyzeModalProps) {
